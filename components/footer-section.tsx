export function FooterSection() {
  return (
    <div className="w-full pt-10 flex flex-col justify-start items-start bg-background border-t border-border">
      {/* Main Footer Content */}
      <div className="self-stretch h-auto flex flex-col md:flex-row justify-between items-stretch pr-0 pb-8 pt-0">
        <div className="h-auto p-4 md:p-8 flex flex-col justify-start items-start gap-8">
          ...
          <div className="self-stretch flex justify-start items-center gap-3">
            <div className="text-center text-foreground text-xl font-semibold leading-4 font-sans flex items-center gap-2">
              snow.fun ❄️
            </div>
          </div>
          <div className="text-muted-foreground text-sm font-medium leading-[18px] font-sans">
            Building delightful snowball experiences
          </div>
        ...
        <div className="self-stretch p-4 md:p-8 flex flex-col sm:flex-row flex-wrap justify-start sm:justify-between items-start gap-6 md:gap-8">
          ...
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            <div className="self-stretch text-muted-foreground text-sm font-medium leading-5 font-sans">Product</div>
            <div className="flex flex-col justify-end items-start gap-2">
              <div className="text-foreground/70 text-sm font-normal leading-5 font-sans cursor-pointer hover:text-primary transition-colors">
                Features
              </div>
              <div className="text-foreground/70 text-sm font-normal leading-5 font-sans cursor-pointer hover:text-primary transition-colors">
                Snowballs
          ...
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            ...
            <div className="flex flex-col justify-center items-center gap-2">
              <div className="self-stretch text-foreground/70 text-sm font-normal leading-5 font-sans cursor-pointer hover:text-primary transition-colors">
                Documentation
              </div>
              <div className="self-stretch text-foreground/70 text-sm font-normal leading-5 font-sans cursor-pointer hover:text-primary transition-colors">
                Guides
      ...
      <div className="self-stretch h-12 relative overflow-hidden border-t border-border flex items-center justify-center">
        <p className="text-muted-foreground text-sm">© 2025 snow.fun. All rights reserved.</p>
      </div>
    </div>
  )
}
